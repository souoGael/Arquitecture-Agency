...
import b1 from '../../assets/placeholder2.jpg';
import b2 from '../../assets/placeholder2.jpg';
import b3 from '../../assets/placeholder2.jpg';
...
const P2 = () => {
    ...
    return (
        <>
            <div className='md:px-14 mt-20 max-w-screen-2xl mx-auto' id='P2'>
                ...
                {images.map((image, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            ref={ref}
                            className={`px-4 md:px-14 mb-20"}`}
                        >
                            <img className="h-auto max-w-full" src={image} alt={`banner-${index}`} />
                        </div>
                    );
                })}
            </div> */}