...
import b2 from '../../assets/placeholder1.jpg';
import b3 from '../../assets/placeholder1.jpg';
import b4 from '../../assets/placeholder1.jpg';
...
const P1 = () => {
    ...
    return (
        <>
            <div className='md:px-14 mt-20 max-w-screen-2xl mx-auto' id='P1'>
            ...
            <div className='md:px-14 px-4 flex items-center justify-between w-full mb-20'>
                <div className="flex items-center space-x-6 cursor-pointer transform transition duration-300 hover:-translate-x-1" onClick={() => handleClick("p4")}>
                    <BsArrowLeft className="text-neutralDGrey text-4xl" aria-label="left"/>
                    <p className="text-neutralDGrey text-sm">P4</p> 
                </div>
                <div className="flex items-center space-x-6 cursor-pointer transform transition duration-300 hover:translate-x-1" onClick={() => handleClick("p2")}>
                    <p className="text-neutralDGrey text-sm">P2</p> 
